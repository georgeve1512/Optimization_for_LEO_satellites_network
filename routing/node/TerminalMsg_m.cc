...
Register_Class(TerminalMsg)

TerminalMsg::TerminalMsg(const char *name, short kind) : ::omnetpp::cPacket(name, kind)
{
}

TerminalMsg::TerminalMsg(const TerminalMsg& other) : ::omnetpp::cPacket(other)
{
    copy(other);
}
...
TerminalMsg& TerminalMsg::operator=(const TerminalMsg& other)
{
...
void TerminalMsg::copy(const TerminalMsg& other)
{
...
void TerminalMsg::setSrcAddr(int srcAddr)
{
    this->srcAddr = srcAddr;
}

int TerminalMsg::getDestAddr() const
{
    return this->destAddr;
}

void TerminalMsg::setDestAddr(int destAddr)
{
    this->destAddr = destAddr;
}

int TerminalMsg::getPacketType() const
{
    return this->packetType;
}

void TerminalMsg::setPacketType(int packetType)
{
...
Register_ClassDescriptor(TerminalMsgDescriptor)

TerminalMsgDescriptor::TerminalMsgDescriptor() : omnetpp::cClassDescriptor(omnetpp::opp_typename(typeid(TerminalMsg)), "omnetpp::cPacket")
{
    propertynames = nullptr;
}

TerminalMsgDescriptor::~TerminalMsgDescriptor()
{
    delete[] propertynames;
}

bool TerminalMsgDescriptor::doesSupport(omnetpp::cObject *obj) const
{
    return dynamic_cast<TerminalMsg *>(obj)!=nullptr;
}

const char **TerminalMsgDescriptor::getPropertyNames() const
{
    if (!propertynames) {
...
const char *TerminalMsgDescriptor::getProperty(const char *propertyname) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
...
const char *TerminalMsgDescriptor::getFieldTypeString(int field) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
...
const char *TerminalMsgDescriptor::getFieldProperty(int field, const char *propertyname) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
...
int TerminalMsgDescriptor::getFieldArraySize(void *object, int field) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
    ...
    TerminalMsg *pp = (TerminalMsg *)object; (void)pp;
    switch (field) {
        default: return 0;
    }
}

const char *TerminalMsgDescriptor::getFieldDynamicTypeString(void *object, int field, int i) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
...
std::string TerminalMsgDescriptor::getFieldValueAsString(void *object, int field, int i) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
...
bool TerminalMsgDescriptor::setFieldValueAsString(void *object, int field, int i, const char *value) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
...
const char *TerminalMsgDescriptor::getFieldStructName(int field) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
...
void *TerminalMsgDescriptor::getFieldStructValuePointer(void *object, int field, int i) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
